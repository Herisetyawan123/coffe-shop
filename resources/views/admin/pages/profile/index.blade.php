...
@section('content')
    <section class="max-w-9xl mx-auto w-full px-4 py-8 sm:px-6 lg:px-8">
        <div class="panel">
            <div class="mb-5 flex items-center justify-between">
                <h5 class="dark:text-white-light text-lg font-semibold">Profile</h5>

                <a href="{{ route('admin.profile.edit') }}" class="btn btn-primary rounded-full p-2 ltr:ml-auto rtl:mr-auto">
            ...
            <div class="mb-5">
                <div class="flex flex-col items-center justify-center">
                    <img src="{{ auth()->user()->photo }}" alt="image" class="mb-5 h-24 w-24 rounded-full object-cover">
                    <p class="text-primary text-xl font-semibold">{{ auth()->user()->name }}</p>
                </div>
                <ul class="text-white-dark m-auto mt-5 flex flex-col space-y-4 font-semibold" style="max-width: 260px;">
                    <li class="flex items-center gap-2">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                stroke="currentColor" stroke-width="1.5"></path>
                            <path opacity="0.5" d="M17 17H19C20.6569 17 22 15.6569 22 14C22 12.3431 20.6569 11 19 11H17.5"
                                stroke="currentColor" stroke-width="1.5"></path>
                            <path opacity="0.5"
