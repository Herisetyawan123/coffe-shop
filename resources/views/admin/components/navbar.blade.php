        ...
        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                <a href="{{ url('/admin/dashboard') }}" class="main-logo flex shrink-0 items-center">
                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1 rounded"
                        src="{{ asset('assets-admin/images/coffe-shop.jpg') }}" alt="image" />
                    <span
                        class="hidden align-middle text-xl font-semibold transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">Coffee</span>
                </a>
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="group relative" @click="toggle()">
                        <span><img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100"
                                src="{{ auth()->user()->photo }}" alt="image" /></span>
                    </a>
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <li>
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="h-10 w-10 rounded-md object-cover" src="{{ auth()->user()->photo }}"
                                        alt="image" />
                                </div>
                        ...
                        <li>
                            <a href="{{ route('admin.profile') }}" class="dark:hover:text-white" @click="toggle">
                        ...
                        <form action="{{ route('logout') }}" method="POST">
                            ...
                            <li class=" border-t border-white-light dark:border-white-light/10">
                                <a class="!py-3 text-danger" @click="toggle">
